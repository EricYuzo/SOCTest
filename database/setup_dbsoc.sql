...
CREATE TABLE TB_EMPRESA_FUNCIONARIO (
  ID_EMPRESA_FUNCIONARIO INT NOT NULL AUTO_INCREMENT,
  ID_EMPRESA INT NOT NULL,
  ID_FUNCIONARIO INT NOT NULL,
  NM_SETOR VARCHAR(100) NOT NULL,
  NM_CARGO VARCHAR(100) NOT NULL,
  PRIMARY KEY (ID_EMPRESA_FUNCIONARIO),
  INDEX (ID_EMPRESA),
  INDEX (ID_FUNCIONARIO),
  INDEX (ID_EMPRESA, ID_FUNCIONARIO, NM_SETOR, NM_CARGO),
  UNIQUE KEY ID_EMPRESA_FUNCIONARIO_SETOR_CARGO (ID_EMPRESA, ID_FUNCIONARIO, NM_SETOR, NM_CARGO),
...
CREATE TABLE TB_EXAME (
  ...
  ID_EMPRESA_FUNCIONARIO INT NOT NULL,
  PRIMARY KEY (ID_EXAME),
  INDEX (ID_FINALIDADE),
  INDEX (ID_RESULTADO),
  INDEX (ID_MEDICO),
  INDEX (ID_EMPRESA_FUNCIONARIO),
  ...
  FOREIGN KEY (ID_EMPRESA_FUNCIONARIO) REFERENCES TB_EMPRESA_FUNCIONARIO(ID_EMPRESA_FUNCIONARIO)
) ENGINE=INNODB;
...
VALUES
('2020-04-20 09:10:05.000', 2, 1, 1,  2),
('2020-04-20 11:00:00.000', 1, 1, 2,  9),
('2020-04-20 11:25:00.000', 3, 1, 3,  1),
('2020-04-20 15:00:00.000', 4, 2, 2,  6),
('2020-04-20 16:00:00.000', 5, 3, 1, 10);
